...
def process_stock(instrument_key: str, stock_name: str, stock_from_date: str, stock_to_date: str):
    try:
        ...
        headers = {
            "Authorization": "eyJ0eXAiOiJKV1QiLCJrZXlfaWQiOiJza192MS4wIiwiYWxnIjoiSFMyNTYifQ.eyJzdWIiOiI3REFWOTMiLCJqdGkiOiI2OGE5NzdkYjFkMGM2OTA4OGM3ZTM4MDUiLCJpc011bHRpQ2xpZW50IjpmYWxzZSwiaXNQbHVzUGxhbiI6ZmFsc2UsImlhdCI6MTc1NTkzNjczMSwiaXNzIjoidWRhcGktZ2F0ZXdheS1zZXJ2aWNlIiwiZXhwIjoxNzU1OTg2NDAwfQ.YDWv6t50Kag_AQPQTtd0QC1sO2Sg7W0gX-a75svjd8g"  # Replace with your actual token
        }
        ...
        df = df.drop("_ema_12", "_ema_26", "_signal", "_hist")
