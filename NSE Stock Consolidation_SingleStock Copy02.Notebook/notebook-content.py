...
def process_stock(instrument_key: str, stock_name: str, stock_from_date: str, stock_to_date: str):
    try:
        ...
        headers = {
            "Authorization": "eyJ0eXAiOiJKV1QiLCJrZXlfaWQiOiJza192MS4wIiwiYWxnIjoiSFMyNTYifQ.eyJzdWIiOiI3REFWOTMiLCJqdGkiOiI2ODhlZjY3YmU4ZTJkZDExZDY3NWIyNTciLCJpc011bHRpQ2xpZW50IjpmYWxzZSwiaXNQbHVzUGxhbiI6ZmFsc2UsImlhdCI6MTc1NDE5OTY3NSwiaXNzIjoidWRhcGktZ2F0ZXdheS1zZXJ2aWNlIiwiZXhwIjoxNzU0MjU4NDAwfQ.HKDAYlWkR-8_ezHzPp5nEBIhm0j3Mcq7MHOcas9JjIA"  # Replace with your actual token
        }
        ...
        df = df.select('datetime_ist', 'datetime', 'open', 'high', 'low', 'close', 'volume')
        #display(df)
...
try:
    result_df = process_stock("NSE_EQ|INE040A01034", "HDFC BANK LTD", stock_from_date, stock_to_date)
...
df = spark.sql("SELECT * FROM stklakehouse.stockcontest_20250803 LIMIT 1000")
display(df)
